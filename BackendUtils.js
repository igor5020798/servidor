...
class UserModel {
  ...
  static async create(deviceId, platformData = {}) {
    ...
    const username = `.gg/sgboss<color=orange><sup>#${userId}`;
  ...
  static tournaments = [
    {
      ...
      nameKey: "Stumble Pit 1v1",
      descriptionKey: "Practice your skills in the Stumble Pit 1v1 TournamentX! mode!",
    ...
    },
    {
      ...
      startTime: new Date(),
      endTime: new Date(Date.now() + 365 * 24 * 60 * 60 * 1000),
      nameKey: "Stumble Pit 2v2 ",
      descriptionKey: "Practice your skills in the Stumble Pit 2v2 TournamentX! mode!",
